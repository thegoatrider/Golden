...
//2nd state code
  ...
  fill(255,153,0);
  textSize(35);
  text('Please stand 10 metres away',120,200);
 ...
 //   button5.hide();
  ...
  if(gameState === 7){
    ...
    if(yes == 1){
      fill(23, 106, 207);
      textSize(30)
      text('Please consult a Doctor and reduce screen exposure!',150,250)
    }
   else if(yes == 2){
     fill(23, 106, 207);
      textSize(30)
      text('Please consult a Doctor and eat healthy!',150,290)
    }
   else if(yes == 3){
      textSize(30)
      fill(23, 106, 207);
      text('Please take good care.',150,330)
    }
   else if(yes == 4){
      textSize(30)
      fill(23, 106, 207);
